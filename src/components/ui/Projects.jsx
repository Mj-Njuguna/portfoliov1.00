  ...
  return (
    <div className="group relative overflow-hidden">
      ...
      >
        ...
        {/* Project Info */}
        <div className="absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-black/60 to-transparent p-6 text-white transition-opacity duration-500 opacity-90 group-hover:opacity-100">
